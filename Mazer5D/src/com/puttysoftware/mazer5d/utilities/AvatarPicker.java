...
public class AvatarPicker {
    ...
    public static AvatarImageModel pickAvatar() {
        ...
        if (avatarFamily != ImageListWithDescDialog.CANCEL) {
            final int avatarSkin = AvatarPicker.pickAvatarSkinColor(
                    avatarFamily, randomHair);
            if (avatarSkin != ImageListWithDescDialog.CANCEL) {
                final int avatarHair = AvatarPicker.pickAvatarHairColor(
                        avatarFamily, avatarSkin);
    ...
    private static int pickAvatarFamily(final int randomSkinID,
        ...
        final BufferedImageIcon[] input = new BufferedImageIcon[] {
                AvatarImageLoader.load(0, new AvatarImageModel(0, randomSkinID,
                        randomHairID).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(1, randomSkinID,
                                        randomHairID).getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(2, randomSkinID,
                        randomHairID).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(3, randomSkinID,
                                        randomHairID).getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(4, randomSkinID,
                        randomHairID).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(5, randomSkinID,
                                        randomHairID).getRules()) };
    ...
    private static int pickAvatarSkinColor(final int familyID,
        ...
        final BufferedImageIcon[] input = new BufferedImageIcon[] {
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, 0,
                        randomHairID).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(familyID, 1, randomHairID)
                                        .getRules()), AvatarImageLoader.load(0,
                                                new AvatarImageModel(familyID,
                                                        2, randomHairID)
                                                                .getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, 3,
                        randomHairID).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(familyID, 4, randomHairID)
                                        .getRules()), AvatarImageLoader.load(0,
                                                new AvatarImageModel(familyID,
                                                        5, randomHairID)
                                                                .getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, 6,
                        randomHairID).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(familyID, 7, randomHairID)
                                        .getRules()), AvatarImageLoader.load(0,
                                                new AvatarImageModel(familyID,
                                                        8, randomHairID)
                                                                .getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, 9,
                        randomHairID).getRules()) };
    ...
    private static int pickAvatarHairColor(final int familyID,
        ...
        final BufferedImageIcon[] input = new BufferedImageIcon[] {
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID,
                        0).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(familyID, skinID, 1)
                                        .getRules()), AvatarImageLoader.load(0,
                                                new AvatarImageModel(familyID,
                                                        skinID, 2).getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID,
                        3).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(familyID, skinID, 4)
                                        .getRules()), AvatarImageLoader.load(0,
                                                new AvatarImageModel(familyID,
                                                        skinID, 5).getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID,
                        6).getRules()), AvatarImageLoader.load(0,
                                new AvatarImageModel(familyID, skinID, 7)
                                        .getRules()), AvatarImageLoader.load(0,
                                                new AvatarImageModel(familyID,
                                                        skinID, 8).getRules()),
                AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID,
