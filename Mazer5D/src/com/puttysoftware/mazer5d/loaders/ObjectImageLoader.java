...
public class ObjectImageLoader {
    ...
    public static BufferedImageIcon getTransformedImage(
            final MazeObject obj, final boolean game) {
        try {
                ...
                for (int x = 0; x < ImageConstants.SIZE; x++) {
                    for (int y = 0; y < ImageConstants.SIZE; y++) {
                        ...
                        if (c.equals(ObjectImageLoader.TRANSPARENT)) {
                            result.setRGB(x, y, ObjectImageLoader.REPLACE
                                    .getRGB());
                        }
                    }
                }
    ...
    public static BufferedImageIcon getVirtualCompositeImage(
        ...
        try {
            ...
            final BufferedImageIcon icon2 = ObjectImageLoader
    ...
    public static BufferedImageIcon load(final MazeObject obj,
            final boolean game) {
    ...
    static BufferedImageIcon getUncachedObjectImage(final MazeObject obj,
        ...
        try {
            ...
            final URL url = ObjectImageLoader.LOAD_CLASS.getResource(
                    ObjectImageLoader.LOAD_PATH + normalName + ".png");
