...
public class GameObjects {
    ...
    static {
        GameObjects.allObjectUIDs = new MazeObjects[] { MazeObjects.AMETHYST,
                MazeObjects.ANNIHILATION_WAND, MazeObjects.A_PLUG,
                MazeObjects.A_PORT, MazeObjects.AQUA_BOOTS, MazeObjects.ARROW,
                MazeObjects.ARROW_TRAP, MazeObjects.AXE,
                MazeObjects.BARRIER_GENERATOR, MazeObjects.BIO_HAZARD_BOOTS,
                MazeObjects.BLACK_CRYSTAL, MazeObjects.BLUE_BUTTON,
                MazeObjects.BLUE_CARPET, MazeObjects.BLUE_CRYSTAL,
                MazeObjects.BLUE_HOUSE, MazeObjects.BLUE_KEY,
                MazeObjects.BLUE_LOCK, MazeObjects.BLUE_WALL_OFF,
                MazeObjects.BLUE_WALL_ON, MazeObjects.BOW, MazeObjects.B_PLUG,
                MazeObjects.B_PORT, MazeObjects.BREAKABLE_WALL_HORIZONTAL,
                MazeObjects.BREAKABLE_WALL_VERTICAL, MazeObjects.BRICK_WALL,
                MazeObjects.BRIGHTNESS_GEM, MazeObjects.CHAIN_TELEPORT,
                MazeObjects.CLOCKWISE_ROTATION_TRAP,
                MazeObjects.CONDITIONAL_CHAIN_TELEPORT,
                MazeObjects.CONDITIONAL_TELEPORT, MazeObjects.CONFUSION_TRAP,
                MazeObjects.CONTROLLABLE_TELEPORT,
                MazeObjects.COUNTERCLOCKWISE_ROTATION_TRAP,
                MazeObjects.COUNTERPOISON_AMULET, MazeObjects.C_PLUG,
                MazeObjects.C_PORT, MazeObjects.CRACKED_WALL,
                MazeObjects.CREVASSE, MazeObjects.CRUMBLING_WALL,
                MazeObjects.CRYSTAL_WALL, MazeObjects.CUT_TREE,
                MazeObjects.CYAN_BUTTON, MazeObjects.CYAN_CARPET,
                MazeObjects.CYAN_CRYSTAL, MazeObjects.CYAN_HOUSE,
                MazeObjects.CYAN_KEY, MazeObjects.CYAN_LOCK,
                MazeObjects.CYAN_WALL_OFF, MazeObjects.CYAN_WALL_ON,
                MazeObjects.DAMAGEABLE_WALL, MazeObjects.DAMAGED_WALL,
                MazeObjects.DARK_BLUE_CRYSTAL, MazeObjects.DARK_CYAN_CRYSTAL,
                MazeObjects.DARK_GEM, MazeObjects.DARK_GRAY_CRYSTAL,
                MazeObjects.DARK_GREEN_CRYSTAL,
                MazeObjects.DARK_MAGENTA_CRYSTAL, MazeObjects.DARKNESS,
                MazeObjects.DARKNESS_GEM, MazeObjects.DARK_RED_CRYSTAL,
                MazeObjects.DARK_WAND, MazeObjects.DARK_YELLOW_CRYSTAL,
                MazeObjects.DESTINATION, MazeObjects.DIAMOND,
                MazeObjects.DIMNESS_GEM, MazeObjects.DIRT,
                MazeObjects.DISARM_TRAP_WAND, MazeObjects.DIZZINESS_TRAP,
                MazeObjects.DOOR, MazeObjects.DOUBLE_HOURGLASS,
                MazeObjects.D_PLUG, MazeObjects.D_PORT, MazeObjects.DRUNK_TRAP,
                MazeObjects.EMPTY, MazeObjects.BOUNDS,
                MazeObjects.ENERGY_SPHERE,
                MazeObjects.ENRAGED_BARRIER_GENERATOR, MazeObjects.E_PLUG,
                MazeObjects.E_PORT, MazeObjects.EXIT,
                MazeObjects.EXPLODING_WALL, MazeObjects.EXPLORE_TRAP,
                MazeObjects.FADING_WALL, MazeObjects.FAKE_FINISH,
                MazeObjects.FAKE_WALL, MazeObjects.FINISH,
                MazeObjects.FINISH_MAKING_WAND, MazeObjects.FINISH_TO,
                MazeObjects.FIRE_AMULET, MazeObjects.FIRE_ARROW,
                MazeObjects.FIRE_BOMB, MazeObjects.FIRE_BOOTS,
                MazeObjects.FIRE_BOW, MazeObjects.FORCE_FIELD,
                MazeObjects.F_PLUG, MazeObjects.F_PORT,
                MazeObjects.GARNET_SQUARE, MazeObjects.GARNET_WALL,
                MazeObjects.GHOST_AMULET, MazeObjects.GHOST_ARROW,
                MazeObjects.GHOST_BOW, MazeObjects.GLUE_BOOTS,
                MazeObjects.GOLDEN_SQUARE, MazeObjects.GOLDEN_WALL,
                MazeObjects.G_PLUG, MazeObjects.G_PORT, MazeObjects.GRASS,
                MazeObjects.GRAY_CRYSTAL, MazeObjects.GREEN_BUTTON,
                MazeObjects.GREEN_CARPET, MazeObjects.GREEN_CRYSTAL,
                MazeObjects.GREEN_HOUSE, MazeObjects.GREEN_KEY,
                MazeObjects.GREEN_LOCK, MazeObjects.GREEN_WALL_OFF,
                MazeObjects.GREEN_WALL_ON, MazeObjects.HALF_HOURGLASS,
                MazeObjects.HAMMER, MazeObjects.HEAL_BOOTS,
                MazeObjects.HEAL_TRAP, MazeObjects.HORIZONTAL_BARRIER,
                MazeObjects.HOT_BOOTS, MazeObjects.HOT_ROCK,
                MazeObjects.HOURGLASS, MazeObjects.H_PLUG, MazeObjects.H_PORT,
                MazeObjects.HURT_TRAP, MazeObjects.ICE, MazeObjects.ICE_AMULET,
                MazeObjects.ICE_ARROW, MazeObjects.ICE_BOMB,
                MazeObjects.ICE_BOW, MazeObjects.ICED_BARRIER_GENERATOR,
                MazeObjects.INVISIBLE_CHAIN_TELEPORT,
                ...
                MazeObjects.INVISIBLE_PIT, MazeObjects.INVISIBLE_SPRINGBOARD,
                MazeObjects.INVISIBLE_TELEPORT, MazeObjects.INVISIBLE_WALL,
                MazeObjects.I_PLUG, MazeObjects.I_PORT, MazeObjects.J_PLUG,
                MazeObjects.J_PORT, MazeObjects.KEY, MazeObjects.K_PLUG,
                MazeObjects.K_PORT, MazeObjects.LAVA,
                MazeObjects.LIGHT_BLUE_CRYSTAL, MazeObjects.LIGHT_CYAN_CRYSTAL,
                MazeObjects.LIGHT_GEM, MazeObjects.LIGHT_GRAY_CRYSTAL,
                MazeObjects.LIGHT_GREEN_CRYSTAL,
                MazeObjects.LIGHT_MAGENTA_CRYSTAL, MazeObjects.LIGHTNESS_GEM,
                MazeObjects.LIGHT_RED_CRYSTAL, MazeObjects.LIGHT_WAND,
                MazeObjects.LIGHT_YELLOW_CRYSTAL, MazeObjects.LOCK,
                MazeObjects.L_PLUG, MazeObjects.L_PORT,
                MazeObjects.MAGENTA_BUTTON, MazeObjects.MAGENTA_CARPET,
                MazeObjects.MAGENTA_CRYSTAL, MazeObjects.MAGENTA_HOUSE,
                MazeObjects.MAGENTA_KEY, MazeObjects.MAGENTA_LOCK,
                MazeObjects.MAGENTA_WALL_OFF, MazeObjects.MAGENTA_WALL_ON,
                MazeObjects.MAJOR_HEAL_POTION, MazeObjects.MAJOR_HURT_POTION,
                MazeObjects.MAJOR_UNKNOWN_POTION,
                MazeObjects.MASTER_TRAPPED_WALL, MazeObjects.MASTER_WALL_TRAP,
                MazeObjects.METAL_BOOTS, MazeObjects.METAL_BUTTON,
                MazeObjects.METAL_DOOR, MazeObjects.METAL_KEY,
                MazeObjects.MINOR_HEAL_POTION, MazeObjects.MINOR_HURT_POTION,
                MazeObjects.MINOR_UNKNOWN_POTION, MazeObjects.MOON_STONE,
                MazeObjects.MOVING_BLOCK, MazeObjects.MOVING_FINISH,
                MazeObjects.M_PLUG, MazeObjects.M_PORT, MazeObjects.NO_BOOTS,
                MazeObjects.NO_EXPLORE_TRAP, MazeObjects.NORMAL_AMULET,
                MazeObjects.N_PLUG, MazeObjects.N_PORT,
                MazeObjects.ONE_SHOT_CHAIN_TELEPORT,
                MazeObjects.ONE_SHOT_CONDITIONAL_TELEPORT,
                MazeObjects.ONE_SHOT_CONTROLLABLE_TELEPORT,
                MazeObjects.ONE_SHOT_TELEPORT, MazeObjects.ONE_WAY_EAST_WALL,
                MazeObjects.ONE_WAY_NORTH_WALL, MazeObjects.ONE_WAY_SOUTH_WALL,
                MazeObjects.ONE_WAY_WEST_WALL, MazeObjects.O_PLUG,
                MazeObjects.O_PORT, MazeObjects.ORANGE_BUTTON,
                MazeObjects.ORANGE_CARPET, MazeObjects.ORANGE_CRYSTAL,
                MazeObjects.ORANGE_HOUSE, MazeObjects.ORANGE_KEY,
                MazeObjects.ORANGE_LOCK, MazeObjects.ORANGE_WALL_OFF,
                MazeObjects.ORANGE_WALL_ON, MazeObjects.PASSWALL_BOOTS,
                MazeObjects.PIT, MazeObjects.PLANT_CRYSTAL, MazeObjects.PLAYER,
                MazeObjects.POISON_ARROW, MazeObjects.POISON_BOMB,
                MazeObjects.POISON_BOW, MazeObjects.POISONED_BARRIER_GENERATOR,
                MazeObjects.POISONOUS_AMULET, MazeObjects.P_PLUG,
                MazeObjects.P_PORT, MazeObjects.PULLABLE_BLOCK,
                MazeObjects.PULLABLE_BLOCK_ONCE,
                MazeObjects.PULLABLE_BLOCK_THRICE,
                MazeObjects.PULLABLE_BLOCK_TWICE, MazeObjects.PURPLE_BUTTON,
                MazeObjects.PURPLE_CARPET, MazeObjects.PURPLE_CRYSTAL,
                MazeObjects.PURPLE_HOUSE, MazeObjects.PURPLE_KEY,
                MazeObjects.PURPLE_LOCK, MazeObjects.PURPLE_WALL_OFF,
                MazeObjects.PURPLE_WALL_ON, MazeObjects.PUSHABLE_BLOCK,
                MazeObjects.PUSHABLE_BLOCK_ONCE,
                MazeObjects.PUSHABLE_BLOCK_THRICE,
                MazeObjects.PUSHABLE_BLOCK_TWICE,
                MazeObjects.PUSHABLE_PULLABLE_BLOCK, MazeObjects.Q_PLUG,
                MazeObjects.Q_PORT, MazeObjects.QUAKE_BOMB,
                MazeObjects.RANDOM_INVISIBLE_ONE_SHOT_TELEPORT,
                MazeObjects.RANDOM_INVISIBLE_TELEPORT,
                MazeObjects.RANDOM_ONE_SHOT_TELEPORT,
                MazeObjects.RANDOM_TELEPORT, MazeObjects.RED_BUTTON,
                MazeObjects.RED_CARPET, MazeObjects.RED_CRYSTAL,
                MazeObjects.RED_HOUSE, MazeObjects.RED_KEY,
                MazeObjects.RED_LOCK, MazeObjects.RED_WALL_OFF,
                MazeObjects.RED_WALL_ON, MazeObjects.REGULAR_BOOTS,
                MazeObjects.REMOTE_ACTION_WAND, MazeObjects.ROSE_BUTTON,
                MazeObjects.ROSE_CARPET, MazeObjects.ROSE_CRYSTAL,
                MazeObjects.ROSE_HOUSE, MazeObjects.ROSE_KEY,
                MazeObjects.ROSE_LOCK, MazeObjects.ROSE_WALL_OFF,
                MazeObjects.ROSE_WALL_ON, MazeObjects.ROTATION_TRAP,
                MazeObjects.ROTATION_WAND, MazeObjects.R_PLUG,
                MazeObjects.R_PORT, MazeObjects.RUBY, MazeObjects.RUBY_SQUARE,
                MazeObjects.RUBY_WALL, MazeObjects.SAND, MazeObjects.SAPPHIRE,
                MazeObjects.SAPPHIRE_SQUARE, MazeObjects.SAPPHIRE_WALL,
                MazeObjects.SEALED_FINISH, MazeObjects.SEALING_WALL,
                MazeObjects.SEAWEED_BUTTON, MazeObjects.SEAWEED_CARPET,
                MazeObjects.SEAWEED_CRYSTAL, MazeObjects.SEAWEED_HOUSE,
                MazeObjects.SEAWEED_KEY, MazeObjects.SEAWEED_LOCK,
                MazeObjects.SEAWEED_WALL_OFF, MazeObjects.SEAWEED_WALL_ON,
                MazeObjects.SHOCK_ARROW, MazeObjects.SHOCK_BOMB,
                MazeObjects.SHOCK_BOW, MazeObjects.SHOCKED_BARRIER_GENERATOR,
                MazeObjects.SHUFFLE_BOMB, MazeObjects.SIGN,
                MazeObjects.SIGNAL_CRYSTAL, MazeObjects.SILVER_SQUARE,
                MazeObjects.SILVER_WALL, MazeObjects.SKY_BUTTON,
                MazeObjects.SKY_CARPET, MazeObjects.SKY_CRYSTAL,
                MazeObjects.SKY_HOUSE, MazeObjects.SKY_KEY,
                MazeObjects.SKY_LOCK, MazeObjects.SKY_WALL_OFF,
                MazeObjects.SKY_WALL_ON, MazeObjects.SLIME,
                MazeObjects.SLIPPERY_BOOTS, MazeObjects.SNOW,
                MazeObjects.S_PLUG, MazeObjects.S_PORT, MazeObjects.SPRINGBOARD,
                MazeObjects.STAIRS_DOWN, MazeObjects.STAIRS_UP,
                MazeObjects.STUMP, MazeObjects.SUNKEN_BLOCK,
                MazeObjects.SUN_STONE, MazeObjects.SUPER_HEAL_POTION,
                MazeObjects.SUPER_HURT_POTION, MazeObjects.SUPER_UNKNOWN_POTION,
                MazeObjects.TABLET, MazeObjects.TABLET_SLOT,
                MazeObjects.TELEPORT, MazeObjects.TELEPORT_WAND,
                MazeObjects.TILE, MazeObjects.TOPAZ_SQUARE,
                MazeObjects.TOPAZ_WALL, MazeObjects.T_PLUG, MazeObjects.T_PORT,
                MazeObjects.TRAPPED_WALL_0, MazeObjects.TRAPPED_WALL_1,
                MazeObjects.TRAPPED_WALL_2, MazeObjects.TRAPPED_WALL_3,
                MazeObjects.TRAPPED_WALL_4, MazeObjects.TRAPPED_WALL_5,
                MazeObjects.TRAPPED_WALL_6, MazeObjects.TRAPPED_WALL_7,
                MazeObjects.TRAPPED_WALL_8, MazeObjects.TRAPPED_WALL_9,
                MazeObjects.TRAPPED_WALL_10, MazeObjects.TRAPPED_WALL_11,
                MazeObjects.TRAPPED_WALL_12, MazeObjects.TRAPPED_WALL_13,
                MazeObjects.TRAPPED_WALL_14, MazeObjects.TRAPPED_WALL_15,
                MazeObjects.TRAPPED_WALL_16, MazeObjects.TRAPPED_WALL_17,
                MazeObjects.TRAPPED_WALL_18, MazeObjects.TRAPPED_WALL_19,
                MazeObjects.TREASURE_CHEST, MazeObjects.TREE,
                MazeObjects.TRUE_SIGHT_AMULET, MazeObjects.TUNDRA,
                MazeObjects.TWO_WAY_TELEPORT, MazeObjects.U_PLUG,
                MazeObjects.U_PORT, MazeObjects.U_TURN_TRAP,
                MazeObjects.VARIABLE_HEAL_TRAP, MazeObjects.VARIABLE_HURT_TRAP,
                MazeObjects.VERTICAL_BARRIER, MazeObjects.V_PLUG,
                MazeObjects.V_PORT, MazeObjects.WALL,
                MazeObjects.WALL_BREAKING_WAND, MazeObjects.WALL_MAKING_TRAP,
                MazeObjects.WALL_MAKING_WAND, MazeObjects.WALL_TRAP_0,
                MazeObjects.WALL_TRAP_1, MazeObjects.WALL_TRAP_2,
                MazeObjects.WALL_TRAP_3, MazeObjects.WALL_TRAP_4,
                MazeObjects.WALL_TRAP_5, MazeObjects.WALL_TRAP_6,
                MazeObjects.WALL_TRAP_7, MazeObjects.WALL_TRAP_8,
                MazeObjects.WALL_TRAP_9, MazeObjects.WALL_TRAP_10,
                MazeObjects.WALL_TRAP_11, MazeObjects.WALL_TRAP_12,
                MazeObjects.WALL_TRAP_13, MazeObjects.WALL_TRAP_14,
                MazeObjects.WALL_TRAP_15, MazeObjects.WALL_TRAP_16,
                MazeObjects.WALL_TRAP_17, MazeObjects.WALL_TRAP_18,
                MazeObjects.WALL_TRAP_19, MazeObjects.WARP_BOMB,
                MazeObjects.WARP_TRAP, MazeObjects.WARP_WAND, MazeObjects.WATER,
                MazeObjects.WHITE_BUTTON, MazeObjects.WHITE_CARPET,
                MazeObjects.WHITE_CRYSTAL, MazeObjects.WHITE_HOUSE,
                MazeObjects.WHITE_KEY, MazeObjects.WHITE_LOCK,
                MazeObjects.WHITE_WALL_OFF, MazeObjects.WHITE_WALL_ON,
                MazeObjects.W_PLUG, MazeObjects.W_PORT, MazeObjects.X_PLUG,
                MazeObjects.X_PORT, MazeObjects.YELLOW_BUTTON,
                MazeObjects.YELLOW_CARPET, MazeObjects.YELLOW_CRYSTAL,
                MazeObjects.YELLOW_HOUSE, MazeObjects.YELLOW_KEY,
                MazeObjects.YELLOW_LOCK, MazeObjects.YELLOW_WALL_OFF,
                MazeObjects.YELLOW_WALL_ON, MazeObjects.Y_PLUG,
                MazeObjects.Y_PORT, MazeObjects.Z_PLUG, MazeObjects.Z_PORT,
                MazeObjects._NONE };
        ...
        final Collection<MazeObject> values = GameObjects.removeNullValues(
                GameObjects.allObjectsLookup.values());
        GameObjects.allObjects = values.toArray(new MazeObject[values
                .size()]);
    }

    private static Collection<MazeObject> removeNullValues(
            final Collection<MazeObject> values) {
        return values.stream().filter(GameObjects.itemNotNull()).collect(
                Collectors.<MazeObject> toList());
    }
    ...
    public static MazeObject[] getAllWithoutPrerequisiteAndNotRequired(
            final int layer) {
    ...
    public static MazeObject[] getAllRequiredSubset(
    ...
    public static MazeObject[] getAllWithoutPrerequisiteAndNotRequiredSubset(
            final MazeObject[] objs, final int layer) {
        if (objs == null) {
            return null;
        }
    ...
    public static MazeObject createContainerObject(final MazeObjects uid,
    ...
    public static MazeObject createTeleportObject(final MazeObjects uid,
    ...
    public static MazeObject readObject(final XDataReader reader,
