...
public final class AvatarImageModel {
    ...
    public AvatarImageModel(final int legacyFamily, final int hair, final int skin) {
	this.familyID = 0;
	this.hairID = hair;
	this.skinID = skin;
    ...
    public AvatarImageModel(final int family, final int hair, final int skin, final int body, final int pants,
	    final int shoes, final int eyes) {
	...
	this.rules.add(AvatarColors.pantsBase, AvatarColors.pantsTable[this.pantsID]);
	this.rules.add(AvatarColors.shoesBase, AvatarColors.shoesTable[this.shoesID]);
