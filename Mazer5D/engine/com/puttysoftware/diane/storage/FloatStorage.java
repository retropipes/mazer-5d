...
/**
 * Data storage for half-precision floating point numbers.
 */
public class FloatStorage {
     ...
     */
    protected final float[] dataStore;
     ...
     */
    public FloatStorage(final int... shape) {
     ...
     */
    public FloatStorage(final FloatStorage source) {
     ...
     * @param shape  simulated dimensions for the stored data
     */
    public FloatStorage(final float[] source, final int... shape) {
        this.dataShape = shape;
        this.interProd = new int[this.dataShape.length];
        int product = 1;
        for (int x = 0; x < this.dataShape.length; x++) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof FloatStorage)) {
            return false;
        }
        final FloatStorage other = (FloatStorage) obj;
     ...
     */
    public final void fill(final float obj) {
     ...
     */
    public final float getCell(final int... loc) {
     ...
     */
    protected final float getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final float obj, final int... loc) {
        final int aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final float obj, final int rawLoc) {
