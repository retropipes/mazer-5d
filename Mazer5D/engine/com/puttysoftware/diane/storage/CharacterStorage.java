...
public class CharacterStorage {
     ...
     */
    protected final char[] dataStore;
     ...
     */
    public CharacterStorage(final int... shape) {
     ...
     */
    public CharacterStorage(final CharacterStorage source) {
     ...
     * @param shape  simulated dimensions for the stored data
     */
    public CharacterStorage(final char[] source, final int... shape) {
        this.dataShape = shape;
        this.interProd = new int[this.dataShape.length];
        int product = 1;
        for (int x = 0; x < this.dataShape.length; x++) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof CharacterStorage)) {
            return false;
        }
        final CharacterStorage other = (CharacterStorage) obj;
     ...
     */
    public final void fill(final char obj) {
     ...
     */
    public final char getCell(final int... loc) {
     ...
     */
    protected final char getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final char obj, final int... loc) {
        final int aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final char obj, final int rawLoc) {
