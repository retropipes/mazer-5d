...
public class EdgeGenerator {
    ...
    private static final String[] FRIENDLY_NAME_SUFFIXES = new String[] { "South", //$NON-NLS-1$
	...
	final int transPoint1 = (int) (dist * pattern.getPosition().getOffset()) - transWidth;
	final int invTransPoint1 = (int) (dist * pattern.getPosition().getOffset()) + transWidth;
