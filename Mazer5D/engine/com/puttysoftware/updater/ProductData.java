...
public class ProductData {
    ...
    public UpdateCheckResults checkForUpdates() throws IOException {
        ...
        try (InputStreamReader isr = new InputStreamReader(this.updateURL.openStream());
        ...
        UpdateCheckResults hasUpdate = new UpdateCheckResults(newMajor, newMinor, newBugfix, newPrerelease);
