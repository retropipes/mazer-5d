 ...
 */
package org.retropipes.mazer5d.file.locking;
...
import org.retropipes.mazer5d.file.InvalidMazeException;
import org.retropipes.mazer5d.file.format.PrefixHandler;
...
public class LockedLoadTask extends Thread {
	...
	try {
		...
		ie.printStackTrace();
		throw new InvalidMazeException("Error loading locked " + sg.toLowerCase() + " file.");
	    }
