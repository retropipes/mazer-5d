...
import org.retropipes.mazer5d.file.TempDirCleanup;
...
public class GUIManager implements QuitHandler {
    ...
    private JButton fileNew, fileOpen, fileOpenLocked, fileClose, fileSave, fileSaveAs, fileSaveLocked, quit, play,
	    edit, helpAbout, helpObjectHelp, showPreferences;
    ...
    @Override
    public void handleQuitRequestWith(final QuitEvent inE, final QuitResponse inResponse) {
